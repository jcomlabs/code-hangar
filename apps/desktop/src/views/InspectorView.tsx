...
export function InspectorView({
  ...
  return (
            ...
            <div className="relationship-group">
              ...
              <ul className="relationship-list">
                {relationships.outgoing.map((relationship) => (
                  <li key={`out-${relationship.projectId}:${relationship.nodeId}-${relationship.path}`}>
                    <button type="button" onClick={() => void openNode(relationship.nodeId, relationship.projectId)} data-help={`Open referenced file ${relationship.displayName}.`}>
            ...
            <div className="relationship-group">
              ...
              <ul className="relationship-list">
                {relationships.incoming.map((relationship) => (
                  <li key={`in-${relationship.projectId}:${relationship.nodeId}-${relationship.path}`}>
                    <button type="button" onClick={() => void openNode(relationship.nodeId, relationship.projectId)} data-help={`Open file linking here: ${relationship.displayName}.`}>
                      <strong>{relationship.displayName}</strong>
                    </button>
                    <span className="relationship-confidence">{plainConfidenceLabel(relationship.confidence, "link")}</span>
                  </li>
    ...
    {explainPanel}
    <CommentsPanel nodeId={preview?.nodeId ?? null} editionExtensionActive={editionExtensionActive} />
    </>
  );
}
