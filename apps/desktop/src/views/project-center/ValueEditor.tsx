...
export const ValueEditor = memo(function ValueEditor({
  ...
  return (
    <div className="value-editor">
      ...
      />
      <PreviousVersions nodeId={nodeId} saving={savingId !== null} onFileMutated={async (changedNodeId) => { await onFileMutated(changedNodeId); await load(); }} setStatusText={setStatusText} />
