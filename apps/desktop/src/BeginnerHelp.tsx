...
export const BEGINNER_HELP = {
  ...
  lineChanges: {
    ...
    paragraphs: [
      ...
      "A comparison tells you what changed, not whether the change is correct. Read the surrounding request, inspect the local evidence and run the project's own checks when you need more confidence."
    ]
  },
  aiConversations: {
  ...
  protected: {
    ...
    paragraphs: [
      ...
      "Protection is deliberately cautious. Temporarily revealing allowed content does not unlock editing or any separate action."
    ]
  },
  references: {
    title: "References",
